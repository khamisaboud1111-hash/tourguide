...
export type GalleryPhoto = { seed: string; tall?: boolean; cat: string; alt: string };

// Full Zanzibar gallery — owner photos + local tour shots.
// Single source of truth: used by the public Gallery AND the admin Media Library
// ("live on site" preview), so the admin always sees exactly what visitors see.
...
export const galleryPhotos: GalleryPhoto[] = [
  ...
  // Spice Farm Tour — Culture & Nature (14 real photos)
  ...
  // Sunset Dhow Cruise — Ocean & Sailing (20 real photos)
  ...
  // Prison Island (Changuu) Tour — Ocean & Wildlife (18 real photos)
  ...
  // Safari Blue Sailing Tour — Ocean & Sailing (11 real photos)
...
export function resolveGallerySrc(seed: string, w: number, h: number): string {
