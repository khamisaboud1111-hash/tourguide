...
function useLeafletIconFix() {
  useEffect(() => {
    // @ts-expect-error â€” private Leaflet internal
...
export default function ExploreMap({ tours }: { tours: Tour[] }) {
  ...
  // Zanzibar center â€” fit all tour markers
        ...
        <Marker key={t.slug} position={[t.coords.lat, t.coords.lng]}>
          <Popup>
            <div className="text-sm min-w-[180px]">
              ...
              <p className="text-stone-600 text-xs mt-1">{t.category} Â· {t.duration} Â· From ${t.priceUsd}</p>
