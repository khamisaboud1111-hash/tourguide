...
function Mark({ variant = "dark" }: { variant: "dark" | "light" }) {
  ...
  // Palette — high contrast for clarity at 40px
  ...
  return (
    ...
    >
      ...
      {/* Dhow hull — more realistic with chine */}
      ...
      {/* Main sail — realistic curved leech */}
