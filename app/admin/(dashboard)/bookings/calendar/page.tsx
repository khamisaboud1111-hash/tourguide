...
const mockBookings = [
  ...
  { day: 15, customer: "Grace M.", tour: "Ngorongoro Day Trip", time: "08:00", status: "deposit_paid" },
    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          <button className="p-2 rounded-lg border border-stone-200 hover:bg-stone-50" aria-label="Previous month">
            <ChevronLeft size={18} />
          </button>
          <span className="font-medium text-stone-700 min-w-[140px] text-center">{month}</span>
          <button className="p-2 rounded-lg border border-stone-200 hover:bg-stone-50" aria-label="Next month">
      ...
      <div className="mt-6 rounded-2xl border border-stone-200 bg-white p-5">
        <h2 className="font-display text-lg font-semibold mb-3 flex items-center gap-2">
          <CalendarDays size={18} className="text-clove-600" /> Legend
        </h2>
        <div className="flex flex-wrap gap-4 text-sm">
          <span className="inline-flex items-center gap-2"><span className="h-3 w-3 rounded bg-lagoon-100 border border-lagoon-200 inline-block" /> Confirmed</span>
          <span className="inline-flex items-center gap-2"><span className="h-3 w-3 rounded bg-saffron-100 border border-saffron-200 inline-block" /> Pending deposit</span>
          <span className="inline-flex items-center gap-2"><span className="h-3 w-3 rounded bg-saffron-50 border border-saffron-200 inline-block" /> Pending</span>
        </div>
      </div>
    </div>
  );
