...
export const metadata: Metadata = {
  title: `About ${business.guideName} â€” ${business.name}`,
...
const pillars = [
  { n: "01", title: "Local knowledge", body: "Places beyond the standard route â€” a quiet alley, a farm at the right hour, a calm sea only locals know." },
  { n: "02", title: "Personal attention", body: "Small groups, private options, and timing that bends to you â€” not the other way around." },
  { n: "03", title: "Flexible experiences", body: "Half-day, full-day, sunrise or sunset â€” shaped around your stay, hotel, and interests." },
  { n: "04", title: "Authentic experiences", body: "Culture, food, history and nature â€” introduced by someone who lives it." },
  { n: "05", title: "Direct communication", body: "Message the guide directly. No agency, no markups, no scripts." },
];

const favoritePlaces = [
  { name: "Darajani Market at 8am", note: "Before the crowds â€” spices, gossip, and the best mandazi." },
    ...
    <div>
      ...
      <div className="container-page py-10 md:py-16 grid md:grid-cols-5 gap-8 md:gap-12 items-start">
        <div className="md:col-span-2">
          <div className="relative aspect-[4/5] rounded-2xl overflow-hidden shadow-card">
            <Image src={placeholderPhoto("guide-portrait-2", 800, 1000)} alt={`${business.guideName} â€” Zanzibar tour guide portrait`} fill sizes="(min-width:768px) 40vw, 100vw" className="object-cover" priority />
            <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-indigo-900/70 to-transparent p-4">
              ...
              <p className="text-stone-200 text-xs">Licensed guide Â· {business.location}</p>
            </div>
          </div>
            ...
            <ul className="mt-3 space-y-3">
              {favoritePlaces.map((p) => (
                <li key={p.name} className="text-sm">
                  ...
                  <span className="text-stone-600"> â€” {p.note}</span>
                </li>
              ))}
            </ul>
          </div>
        ...
        <div className="md:col-span-3">
          ...
          <p className="mt-2 text-lagoon-700 font-medium text-sm flex flex-wrap gap-2 items-center">
            ...
            <span className="inline-flex items-center gap-1.5 rounded-full bg-stone-100 border border-stone-200 px-3 py-1 text-stone-700 text-xs"><Languages size={12} /> EN Â· SW</span>
          ...
          <div className="mt-6 space-y-4 text-stone-700 leading-relaxed max-w-xl text-[15px]">
            ...
            <p>
              This is where the guide&apos;s personal story lives â€” where you grew up, how long you&apos;ve been guiding, and what first made you want to show this island to visitors. Specifics travel well: the first tour you ever led, a favorite spice, a particular alley you never tire of.
            </p>
            <p className="text-stone-600 text-sm border-l-2 border-saffron-300 pl-4 italic">
              Tip: use first-person, keep it human. One honest paragraph beats corporate marketing. Replace this placeholder with your own words â€” guests book people, not brochures.
            </p>
            <p>
              What guests can expect: unhurried pace, room for questions, and the kind of small details a guidebook won&apos;t tell you â€” the best hour for a spice farm, which sandbank is calmest today, where the light hits the doors at sunset.
            </p>
          </div>
          ...
          <div className="mt-6 rounded-2xl bg-stone-50 border border-stone-200 p-5">
            ...
            <p className="text-xs text-stone-500 mt-2">Fastest reply on WhatsApp â€” {business.phoneDisplay}</p>
          </div>
      ...
      <section className="bg-stone-100 py-12 md:py-16">
        <div className="container-page">
          ...
          <p className="mt-6 text-xs text-stone-500 max-w-3xl">Claims are kept factual â€” no invented awards or certifications. If you add a verifiable credential (license number, years active), it appears here automatically via <code>lib/constants.ts</code>.</p>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div>
            ...
            <ol className="mt-4 space-y-3 text-sm text-stone-700 list-decimal list-inside marker:text-clove-600">
              ...
              <li><span className="font-medium text-stone-900">I pick the timing.</span> Tide, light, farm hours â€” so it actually makes sense.</li>
