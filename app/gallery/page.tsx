...
export default function GalleryPage() {
  return (
    <div className="container-page py-10 md:py-14">
      <p className="text-saffron-600 text-xs uppercase tracking-[0.2em] font-medium mb-3">Gallery</p>
      <h1 className="font-display text-4xl md:text-5xl font-semibold max-w-xl text-balance">A few scenes from the island</h1>
